        ...
        <c:forEach var="f" items="${fighterList.data}">
            <div class="allfighters">
                <form class="fighter form-inline my-2 my-lg-0" action="callfight" method="post">
                    ...
                    <button id="accept" type="submit" class="btn btn-secondary" value="accept" name="action">Accept</button>
                    <button id="decline" type="submit" class="btn btn-success" value="decline" name="action">Decline</button>
